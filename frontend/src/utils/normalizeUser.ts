...
export const normalizeUser = (
  ...
  return {
    ...
    verificationCode: options?.clearVerificationCode ? undefined : data?.verificationCode,
    resetPasswordCode: options?.clearVerificationCode ? undefined : data?.resetPasswordCode,
